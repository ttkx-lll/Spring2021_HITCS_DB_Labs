...
public class StudyUpdateMenu extends JFrame{
	...
	public StudyUpdateMenu()
	{
		...
		lblid_3.setBounds(90, 150, 60, 23);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String[] items = {score, sid, cid};
				Update update = new Update();
				update.updateStudy(items);
			}
		});
