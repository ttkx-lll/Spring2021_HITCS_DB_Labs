...
public class StudentDeleteMenu extends JFrame{
	private static final long serialVersionUID = 1158897003425269987L;
	private JPanel contentPane;
	public StudentDeleteMenu()
	{
		//页面大小调整
		...
		//提示文字
		JLabel lblid = new JLabel("输入要删除的学生信息");
...
//		contentPane.add(textField_2, BorderLayout.CENTER);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String[] items = {sid, sname, ssex, classNum, grade, birthYear, tid, did};
				Delete delete = new Delete();
				delete.deleteStudent(items);
			}
		});
