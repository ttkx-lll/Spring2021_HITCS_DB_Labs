...
public class CourseInquiryMenu extends JFrame{
	private static final long serialVersionUID = 1158897003425269987L;
	private JPanel contentPane;
	public CourseInquiryMenu()
	{
		//页面大小调整
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<Vector<String>> result = inquiry.inquiryCourse(item);
				CourseTable table = new CourseTable(result);
