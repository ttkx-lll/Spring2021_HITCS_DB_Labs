...
public class CourseInsertMenu extends JFrame{
	...
	public CourseInsertMenu()
	{
		...
		//提示文字
		JLabel lblid = new JLabel("输入要插入的课程信息");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String[] items = {cid, cname, book, lbuild, lroom, tid, did};
				Insert insert = new Insert();
				insert.insertCourse(items);
			}
		});
