...
public class StudentInquiryMenu extends JFrame{
	private static final long serialVersionUID = 1158897003425269987L;
	private JPanel contentPane;
	public StudentInquiryMenu()
	{
		//页面大小调整
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<Vector<String>> result = inquiry.inquiryStudent(item);
				StudentTable table = new StudentTable(result);
