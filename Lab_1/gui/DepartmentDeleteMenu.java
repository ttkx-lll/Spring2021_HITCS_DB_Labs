...
public class DepartmentDeleteMenu extends JFrame{
	private static final long serialVersionUID = 1158897003425269987L;
	private JPanel contentPane;
	public DepartmentDeleteMenu()
	{
		//页面大小调整
		...
		//提示文字
		JLabel lblid = new JLabel("输入要删除的学院信息");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String[] items = {did, dname, tid};
				Delete delete = new Delete();
				delete.deleteDepartment(items);
			}
		});
